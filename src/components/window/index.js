...
import { topWindow, connectFun } from '../../state';
...
export class Window extends Component {
  ...
  render() {
    const { window: wndw, app, actions } = this.props;
    const { file, zIndex } = wndw;
    const App = app.component;

    const refCapturer = App instanceof Component ? ref => (this._app = ref) : null;
        ...
        <Draggable handle=".title-bar" bounds="parent">
          ...
          >
            ...
            <div className="window-content">
              <SubspaceProvider mapState={(_, rootState) => rootState}>
...
function mapStateToProps(state, { window: wndw }) {
  return { focused: topWindow(state) === wndw };
}

export default connectFun(mapStateToProps)(Window);
